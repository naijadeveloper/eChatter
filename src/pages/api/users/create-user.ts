...
async function otpGeneration(_id: string, email: string) {
  ...
  const otp = otpCollection.create({
    userId: _id,
    otpCode: hashedOtp
  });
  ...
  await transporter.sendMail({
    ...
    html: `<p>This one-time-password was generated and sent to your email to verify your account, please enter this code in order to verify your account. <br /> <strong style="font-size: 24px">${otpNumber}</strong>
    </p>`
  })
}